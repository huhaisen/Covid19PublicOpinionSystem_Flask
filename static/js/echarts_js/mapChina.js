...
var provinceDistribute = echarts.init(document.getElementById('chart_map'));

function queryStaProvinceDistribute(){
    $.ajax({
        url : '/queryStaProvinceDistribute',
        type: 'get',
        dataType: 'json',
        data: {},
    ...
    // 使用刚指定的配置项和数据显示图表。
            provinceDistribute.setOption(provinceDistribute_option);
        },
        error:function (msg) {
            console.log(msg)
        }
...
queryStaProvinceDistribute()
setInterval(queryStaProvinceDistribute, 1000 * 60 * 60)
